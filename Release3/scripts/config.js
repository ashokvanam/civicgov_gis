   ...
   // FIELD_ALIAS:["MBL#", "ADDRESS"],
    ...
    layers:{
        0:{
            ...
            displayFieldNames:['RPS Link','PARCEL_ADDRESS','PARCEL_CITY','OWNER','OWNER2','MAILING_ADDRESS','MAILING_ADDRESS_1','MAILING_ADDRESS_2','MAILING_CITY','MAILING_ZIP','ACRES','PROP_CLASS','FRONT','DEPTH','SWIS_CODE','DEED_BOOK','DEED_PAGE','PRINTKEY'
        ],
            records:{
