var searchcontrols_config = {
	Asset:{enable:true, keyField:'PID',keyFieldType:"number", layer:'Parcel',name:'Parcel', operator:'='},
...
var spatialsearch_config= {
	Parcel:{enable:true, keyField:'PID',keyFieldType:"number", layer:'Parcel',name:'Parcel', operator:'like'},
};
