var searchcontrols_config = {
	Asset:{enable:true, keyField:'RPS_Link',keyFieldType:"text", layer:'Parcel',name:'Parcel', operator:'='},
...
var spatialsearch_config= {
	Parcel:{enable:true, keyField:'RPS_Link',keyFieldType:"text", layer:'Parcel',name:'Parcel', operator:'like'},
};
